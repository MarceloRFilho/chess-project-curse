...
public class King extends ChessPiece{
	...
	public boolean[][] possibleMoves() {
		...
		if (getMoveCount() == 0 && !chessMatch.getCheck()) {
			// King side
			Position nKing = new Position(position.getRow(), position.getColumn() + 3);
			if (testRookCastling(nKing)) {
			...
			// Queen side
			Position nQueen = new Position(position.getRow(), position.getColumn() - 4);
			if (testRookCastling(nQueen)) {
